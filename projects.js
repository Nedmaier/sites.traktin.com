const projects = [
  ...
  },
  {
    ...
    logo: "media/genlab_logo.png",
    screenshots: [
      "media/aerohunt_architecture.png"
    ],
    description: `
      <p><b>GenLab</b> — интеграционный AI-контур для подготовки, обработки и автоматической публикации материалов. Проект связывает инструменты генерации и обработки контента с production-системами, блогом и внешними площадками.</p>
    ...
    solutions: [
      ...
      },
      {
        ...
        description: `
          <p>Все входящие запросы, ошибки и результаты публикации фиксируются в системных логах. GenLab работает внутри инфраструктуры AeroHunt и использует общие компоненты PHP/MySQL, JSON, фоновые процессы и мониторинг.</p>
        `
      }
    ]
  },
